    ...
    stations.forEach(station => {
      ...
      const popupContent = `
        <div class="p-3 min-w-56 max-w-xs">
          ...
          <button 
            onclick="window.open('https://maps.google.com/maps?q=${encodeURIComponent(station.name.replace(/^(Dubai Can - |Water Station - |Refill Point - |Refill - |Station - )/i, ''))}, Dubai', '_blank')"
